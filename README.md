...
**What I work with:** JavaScript/TypeScript across the stack—React for interfaces, Node.js for APIs, GraphQL and REST, with enough DevOps knowledge to deploy without panicking.
